...
BURIQ () {
    curl -sS https://raw.githubusercontent.com/Rolka111111/sc/ipuk/izin > /root/tmp
...
Name=$(curl -sS https://raw.githubusercontent.com/Rolka111111/sc/ipuk/izin | grep $MYIP | awk '{print $2}')
...
PERMISSION () {
    MYIP=$(curl -sS ipv4.icanhazip.com)
    IZIN=$(curl -sS https://raw.githubusercontent.com/Rolka111111/sc/ipuk/izin | awk '{print $4}' | grep $MYIP)
    if [ "$MYIP" = "$IZIN" ]; then
    Bloman
    else
...
Exp=$(curl -sS https://raw.githubusercontent.com/Rolka111111/sc/ipuk/izin | grep $MYIP | awk '{print $3}')
fi
clear
MYIP=$(curl -sS ipv4.icanhazip.com)
#########################
