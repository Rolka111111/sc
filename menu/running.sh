...
echo -e "# X-Ray Vmess TLS    :$status_tls_v2ray"
echo -e "# X-Ray Vmess NTLS   :$status_nontls_v2ray"
echo -e "# X-Ray Vless TLS     :$status_tls_vless"
echo -e "# X-Ray Vless NTLS    :$status_nontls_vless"
#echo -e "# Shadowsocks-OBFS HTTPS  :$status_sst"
#echo -e "# Shadowsocks-OBFS HTTP   :$status_ssh"
echo -e "# X-Ray Trojan        :$status_virus_trojan"
echo -e "# X-Ray Trojan GO    :$status_trgo"
